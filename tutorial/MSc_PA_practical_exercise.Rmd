...
Here, it's an excecise, so we use the Human footprint layer, which is downloaded from this paper:
...
pz <-
  p2 %>%
  add_boundary_penalties(penalty = 0.003, edge_factor = 0.5) # change the values here
...
# Exercise 4: Lock out land from conservation
...
# Exercise 5: Implementing Marxan
